...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDReloadTime = Animator.StringToHash("ReloadTime");
        ...
        private void Reload()
        {
            ...
            if (!Reloading)
            {
                ...
                if (_input.reload)
                {
                    _reloadTimeoutDelta = ReloadTime;
                    if (_hasAnimator)
                    {
                        _animator.SetFloat(_animIDReloadTime, ReloadTime);
            ...
            {
                if (_reloadTimeoutDelta >= 0.0f)
                {
                    _reloadTimeoutDelta -= Time.deltaTime;
                }
                else
                {
                    _shooterController.RefreshAmmo();
                    Reloading = false;
                }
            }
        }
