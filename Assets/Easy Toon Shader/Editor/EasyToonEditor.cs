...
public class EasyToonEditor : ShaderGUI
{
    ...
    MaterialProperty outlineAdaptiveThickness = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        outlineThickness = FindProperty("_Thickness", props);
        outlineAdaptiveThickness = FindProperty("_AdaptiveThickness", props);
    ...
    private void OutlineEditor()
    {
        List<MaterialProperty> list = new List<MaterialProperty>
            {
                outlineThickness,outlineAdaptiveThickness,outlineType,outlineColor,outlineTextureStrength
            };
