...
Shader "Easy Toon"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_UseRimLight("Use RimLight", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 staticSwitch57 = v.ase_texcoord3.xyz;
				#else
				float3 staticSwitch57 = v.ase_normal;
				#endif
				#ifdef _USEOUTLINE_ON
				float3 staticSwitch365 = ( lerpResult59 * ( staticSwitch57 * _Thickness ) );
				#else
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 temp_cast_0 = (BNNDotL233).xxx;
				...
				float3 break3_g175 = ( max( temp_cast_0 , float3(0,0,0) ) * BNAttenuationColor244 );
				float temp_output_1188_0 = max( max( break3_g175.x , break3_g175.y ) , break3_g175.z );
				...
				float4 temp_cast_1 = (ShadowAtten1412).xxxx;
				float4 ShadowAtten1415 = ( 1.0 == _UseShadows ? temp_cast_1 : float4(1,1,1,1) );
				float4 lerpResult1626 = lerp( _ShadowColor , lerpResult1619 , ShadowAtten1415);
				float2 appendResult356 = (float2(( _LightRampOffset + temp_output_1188_0 ) , 0.0));
				float2 temp_cast_3 = (0.02).xx;
				float2 temp_cast_4 = (0.98).xx;
				float2 clampResult358 = clamp( appendResult356 , temp_cast_3 , temp_cast_4 );
				float4 lerpResult1617 = lerp( ( tex2D( _LightRampTexture, float2( 0.02,0 ) ) * _MainLightColor ) , ( tex2D( _LightRampTexture, clampResult358 ) * _MainLightColor ) , ShadowAtten1415);
				...
				float4 lerpResult1628 = lerp( _ShadowColor , lerpResult1629 , ShadowAtten1415);
				...
				float3 LightWrapVector1181 = temp_cast_7;
				...
				float4 staticSwitch627 = ( float4( ( ( localAdditionalLightsSpecularMy1573 * _AdditionalLightsIntesity * ( _AdditionalLightsSmoothnessMultiplier == 0.0 ? 0.0 : 1.0 ) ) + ( _MainLightColor.rgb * _MainLightIntesity * localFaloffPosterize1578 ) ) , 0.0 ) * Smoothness638 * SpecularColor1388 );
				#else
				float4 staticSwitch627 = float4( 0,0,0,0 );
				#endif
				float4 BNspecularFinalColor243 = staticSwitch627;
				float grayscale1797 = dot(BNDiffuse391.rgb, float3(0.299,0.587,0.114));
				...
				float4 BNBlinnPhongLightning274 = ( BNFinalDiffuse239 + ( BNspecularFinalColor243 * lerpResult695 ) + float4( IndirectSpecular1364 , 0.0 ) );
				...
				float RimLight460 = ( _UseRimLight == 1.0 ? smoothstepResult462 : 0.0 );
...
/*ASEBEGIN
Version=18935
687;73;2019;770;11703.63;-1318.557;3.781476;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;219;-8640.2,-404.9457;Inherit;False;1797.078;446.0921;;9;1415;1412;244;1414;227;247;1842;1843;1844;Light Attenuation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;465;423.3723,-1099.152;Inherit;False;3204.799;1529.321;;19;1644;1647;456;1645;1646;1642;457;537;463;454;467;462;460;458;466;1648;1650;1845;1846;Rim;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.LerpOp;1628;-5297.678,1225.747;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;229;-3639.793,879.2498;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1243;-7901.144,3098.145;Inherit;False;Property;_AdditionalLightsFaloff;Additional Lights Falloff;38;0;Create;False;0;0;0;True;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;271;-3650.352,-361.2921;Inherit;False;239;BNFinalDiffuse;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;642;-3988.578,1008.884;Inherit;False;364;MainTexture;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.NormalizeNode;222;-5534.689,146.8815;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;537;538.2816,-953.8636;Inherit;False;1538;BNCurrentNormal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1416;-5811.629,1344.007;Inherit;False;1415;ShadowAtten;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;467;1032.794,-795.849;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;457;486.6353,-775.9279;Inherit;False;Property;_RimPower;Rim Power;18;0;Create;True;0;0;0;False;0;False;12;1;1;12;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;239;-2803.317,769.5178;Float;True;BNFinalDiffuse;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;693;-4402.304,-54.1281;Inherit;False;391;BNDiffuse;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1844;-8383.072,-123.6224;Inherit;False;Property;_UseShadows;Use Shadows;49;1;[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;458;494.0572,-869.5389;Inherit;False;Property;_RimThickness;Rim Thickness;17;0;Create;True;0;0;0;False;0;False;1;1;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1645;2564.679,-426.1641;Inherit;False;Property;_RimShadowColor;Rim Shadow Color;45;0;Create;False;0;0;0;False;0;False;0,0.05551431,0.9622642,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;466;848.914,-735.0986;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1650;3063.622,-546.4114;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;1644;2451.005,-628.2682;Inherit;False;1554;BNDiffuseNoAdditionalLights;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1647;2973.141,-700.8771;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;456;2510.758,-891.3867;Inherit;False;Property;_RimColor;Rim Color;16;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;454;785.7632,-944.6846;Inherit;False;Standard;WorldNormal;ViewDir;True;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;1648;2756.622,-508.4114;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1845;1506.855,-735.5936;Inherit;False;Property;_UseRimLight;Use RimLight;52;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;462;1261.158,-896.4887;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1508;-8045.536,1809.592;Inherit;False;1415;ShadowAtten;1;0;OBJECT;;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1415;-7941.565,-117.7121;Inherit;False;ShadowAtten;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.Vector4Node;1842;-8273.209,-5.351013;Inherit;False;Constant;_Vector4;Vector 4;51;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1684;-7575.029,1450.475;Inherit;False;MaxFromVector3;-1;;176;92f2539b674dd3042b132cfbdf18809e;0;1;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;1846;1736.728,-845.4712;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1269;-2992.034,1058.561;Inherit;False;IndirectDiffuseLight;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1188;-7435.184,1116.345;Inherit;False;MaxFromVector3;-1;;175;92f2539b674dd3042b132cfbdf18809e;0;1;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1683;-7312.262,1457.329;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.Compare;1843;-8141.93,-156.6854;Inherit;False;0;4;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1098;-6693.153,4020.493;Inherit;False;Property;_AdditionalLightsIntesity;Additional Lights Intensity;35;0;Create;False;0;0;0;True;0;False;1;0;0;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1500;-7856.688,1603.479;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;58;-841.3283,219.3617;Inherit;False;Property;_Thickness;Thickness;4;0;Create;False;0;0;0;False;0;False;0;0;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;463;502.5583,-682.3714;Inherit;False;Property;_RimSmoothness;Rim Smoothness;19;0;Create;True;0;0;0;False;0;False;0;0;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;965;-7234.521,1335.426;Inherit;False;CompleteDiffuseLight;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1363;-3192.625,987.1949;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1404;-6737.913,4481.702;Inherit;False;Property;_MainLightIntesity;Main Light Intensity;42;0;Create;False;0;0;0;False;0;False;1;0;0;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;1626;-5251.492,1022.015;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;392;-3899.86,773.6321;Inherit;False;391;BNDiffuse;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;460;1977.362,-770.0532;Inherit;False;RimLight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;54;-1444.329,249.3617;Inherit;False;3;3;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;1617;-5375.458,893.8284;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-1013.993,-179.219;Inherit;False;Property;_AdaptiveThickness;Adaptive Thickness;5;0;Create;False;0;0;0;False;0;False;0;0.32;0;1;0;1;FLOAT;0
...
WireConnection;1843;1;1844;0
WireConnection;1843;2;1412;4
WireConnection;1843;3;1842;0
...
ASEEND*/
//CHKSM=319DCDDCE83676611A6C609F45494448F11084DF